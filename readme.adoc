...
image::https://badge.waffle.io/chevdor/sql2asciidoc.svg?label=ready&title=ready[link="http://waffle.io/chevdor/sql2asciidoc"] image::https://badge.waffle.io/chevdor/sql2asciidoc.svg?label=inprogress&title=inprogress[link="http://waffle.io/chevdor/sql2asciidoc"] image::https://badge.waffle.io/chevdor/sql2asciidoc.svg?label=done&title=done[link="http://waffle.io/chevdor/sql2asciidoc"]
